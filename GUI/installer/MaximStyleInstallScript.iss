...
#define AppExePath "C:\D\Project\MAXREFDES1219\GUI\USB Charger-V2.1\GUI software\UsbChargerGui_V2.11\UsbChargerGui\bin\Debug"
#define InstallFilesPath "C:\D\Project\MAXREFDES1219\GUI\USB Charger-V2.1\Installer"
#define PartNumber "MAXREFDES1260"
#define AppVersion "1.0"
;#define EVKitName PartNumber + "_GUI"
#define EVKitName "UsbChargerGui"
...
;Source: "dotNetFx40_Full_x86_x64.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "maxim-ico.ico"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\{#AppName}"; Filename: "{app}\{#AppExeName}"; IconFilename: "{app}\{#AppExeName}"; Tasks: desktopicon
Name: "{group}\{cm:UninstallProgram,{#AppName}}"; Filename: "{uninstallexe}"; Tasks: uninstallicon
Name: "{commondesktop}\{#AppName}"; Filename: "{app}\{#AppExeName}"; IconFilename: "{app}\maxim-ico.ico"; IconIndex: 0; Tasks: desktopicon
...
;Filename: {tmp}\dotnetfx35setup.exe; Parameters: ?Q /NORESTART? Check: Is35FrameworkInstalled; Flags: runhidden shellexec waituntilterminated; StatusMsg: “Installing .NET Framework 3.5V?
